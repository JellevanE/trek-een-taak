...
import {
  AddSideQuestForm,
  QuestEditForm,
} from "./features/quest-board/components/forms";
...
const ThemePreviewPage = React.lazy(() =>
  import("./theme/ThemePreviewPage.jsx")
);
...
function App() {
  ...
  const [campaignDetailInitialTab, setCampaignDetailInitialTab] = React
    .useState("story");
  ...
  const renderAddSideQuestForm = React.useCallback(
    (questId, value) => (
      <AddSideQuestForm
        questId={questId}
        value={value}
  ...
  if (isThemePreviewRoute) {
    return (
      <React.Suspense
        fallback={<div className="App container">Loading theme previews…</div>}
      >
        <ThemePreviewPage
      ...
      <div className="board-layout">
        <aside
          className={`campaign-sidebar ${
            campaignSidebarCollapsed ? "collapsed" : ""
          }`}
                  ...
                  {hasCampaigns
                    ...
                    : (
                      <div className="campaign-empty">
                        No campaigns yet. Create one from the backend to start
                        grouping quests.
                      </div>
                    )}
                </div>
          ...
          {campaignDetailId !== null && (
            <CampaignDetailPage
              ...
              onCheckStorylineUpdate={() =>
                checkStorylineUpdate(campaignDetailId)}
