...
const PREVIEW_STATES = [
    ...
    },
    {
        ...
        className: 'quest completed glow',
        progress: 100,
        status: 'Completed',
    },
    {
    ...
    },
    {
        id: 'spawning',
        label: 'Spawning',
        className: 'quest spawn',
        progress: 5,
        status: 'New arrival',
    },
];

const buildStateClass = (className = '') =>
    ['quest-card-preview', className].filter(Boolean).join(' ');
        ...
        <div className='theme-preview-wrapper'>
            <header className='theme-preview-header'>
                <div>
                    ...
                    <p className='theme-preview-subtitle'>
                        Verify every quest state (active, completed, editing, dragging, glowing,
                        pulsing) before shipping theme tokens.
                    </p>
                </div>
                <div className='theme-preview-actions'>
                    ...
                    <label
                        className='theme-audio-control theme-audio-control-inline'
                        htmlFor='theme-preview-sound'
                    >
            ...
            <section className='theme-preview-meta'>
                <div>
                    ...
                    <ul>
                        <li>
                            Load this page and capture screenshots per theme for Percy/Chromatic
                            uploads.
                        </li>
                        <li>
                            Confirm reduced-motion preference removes glow/pulse + mutes the
                            soundtrack.
                        </li>
                ...
                <div>
                    ...
                    <p>
                        Formats: {(soundFxMeta?.formats || ['audio/webm', 'audio/mpeg']).join(', ')}
                        {' '}
                        · Max file size: {soundFxMeta?.maxFileSizeKb ?? 50}kb per clip.
                    </p>
                    <p className='theme-preview-note'>
                        Provide WebM + MP3 fallbacks and respect reduced-motion → mute
                        automatically.
                    </p>
                </div>
            </section>
                    ...
                    >
                        ...
                        <div className='theme-preview-state-grid'>
                            {PREVIEW_STATES.map((state) => (
                                <div
                                    key={state.id}
                                    className={buildStateClass(state.className)}
                                    data-theme-card={profile.id}
                                >
                                    ...
                                    <div className='theme-preview-actions-row'>
                                        <button className='btn-start btn-small' type='button'>
                                            Start
                                        </button>
                                        <button className='btn-complete btn-small' type='button'>
                                            Complete
                                        </button>
                                        <span className='theme-preview-progress'>
                                            {state.progress}%
                                        </span>
                                    </div>
                                </div>
