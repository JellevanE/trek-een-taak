...
export const useToast = () => {
    ...
    const error = React.useCallback((message, duration) => addToast(message, 'error', duration), [
        addToast,
    ]);
    ...
    const info = React.useCallback((message, duration) => addToast(message, 'info', duration), [
        addToast,
    ]);
                        ...
                        {[
                            ...
                            <button
                                ...
                                style={{
                                    ...
                                    border: `2px solid ${
                                        position === pos ? 'var(--neon-cyan)' : 'var(--dark-gray)'
                                    }`,
                                    fontFamily: "'VT323', monospace",
                                    fontSize: '14px',
                                    cursor: 'pointer',
